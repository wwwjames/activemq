 ...
 *
 * @see org.apache.activemq.transport.ws.jetty12.MQTTSocket
 */
@Deprecated public class MQTTSocket extends AbstractMQTTSocket {

    private static final Logger LOG = LoggerFactory.getLogger(MQTTSocket.class);

    public MQTTSocket(String remoteAddress) {
        super(remoteAddress);
        LOG.error( "{} for Jetty 12 is not supported", MQTTSocket.class.getName());
    }
